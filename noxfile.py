...
def tests(session):
    ...
    try:
        ...
        session.run(
            ...
            "--omit=tests/*",
            "--include=src/saltext/saltext_uci/*",
        )
        ...
        session.run(
            ...
            "--omit=src/saltext/saltext_uci/*",
            "--include=tests/*",
        )
        try:
            session.run(
                "coverage", "report", "--show-missing", "--include=src/saltext/saltext_uci/*"
            )
            ...
            #    "--include=src/saltext/saltext_uci/*,tests/*"
            # )
        finally:
