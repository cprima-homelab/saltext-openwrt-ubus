...
# This package is a subdirectory of a shared monorepo (packages/uci/) --
...
# instead (packages/uci/.pre-commit-hooks/make-autodocs.py -> packages/uci/).
repo_path = Path(__file__).resolve().parent.parent
src_dir = repo_path / "src" / "saltext" / "uci"
