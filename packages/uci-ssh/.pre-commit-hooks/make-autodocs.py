...
# This package is a subdirectory of a shared monorepo (packages/uci-ssh/) --
...
# instead (packages/uci-ssh/.pre-commit-hooks/make-autodocs.py -> packages/uci-ssh/).
repo_path = Path(__file__).resolve().parent.parent
src_dir = repo_path / "src" / "saltext" / "uci_ssh"
