...
def dump(config, redact=True):
    ...
    .. code-block:: bash
        ...
        salt router openwrt_ubus.dump network
        salt router openwrt_ubus.dump wireless redact=False
    """
...
def dump_all(redact=True):
    ...
    .. code-block:: bash
        ...
        salt router openwrt_ubus.dump_all
        salt router openwrt_ubus.dump_all redact=False
    """
