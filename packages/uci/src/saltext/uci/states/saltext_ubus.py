...
from saltext.uci._internal import scope
from saltext.uci._internal.ubus_ops import diff_section as _diff_section
from saltext.uci._internal.ubus_ops import resolve_sections as _resolve_sections
