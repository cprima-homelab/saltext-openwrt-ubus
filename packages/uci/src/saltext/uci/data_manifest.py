...
Usage::
    ...
    python -m saltext.uci.data_manifest           # YAML to stdout
    python -m saltext.uci.data_manifest --json    # JSON to stdout
    python -m saltext.uci.data_manifest --check   # path analysis
...
_ANNOTATED_MODULES = [
    ...
    "saltext.uci.sensitivity.project",
    "saltext.uci._internal.ubus_ops",
]
